...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'Goku Black',
  packname:  process.env.PACK_NAME || 'tera baap hai ',
  
  botname:   process.env.BOT_NAME === undefined ? "Nezuko" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Goku Black' : process.env.OWNER_NAME,  
